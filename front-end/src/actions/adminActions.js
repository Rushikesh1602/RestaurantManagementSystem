...
export const signup = (name, username, email, password, role) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/register'
    axios
...
export const signin = (username, password) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/login'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const getstock = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/stocks'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getProfile = () => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/admin/get/${adminId}`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getSupplier = (id) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/supplier/getingredinet/${id}`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const updatestock = (id, name, qty) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/updatestock'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const getmenu = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/menu/getall'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getFeedback = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/feedback'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const getingredinet = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/ingredients/list'
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const addMenuItem = (menuName, category, price, ingredients) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/menu/add'
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const updateProfile = (name, username, email, password, role) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/admin/update/${id}`
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
