...
export const getMOrders = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/manager/orders'
...
export const getChefs = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/chefs'
...
export const postApprovedOrder = (chefId, customerId) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/order/add'
...
export const getAllWaiters = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/admin/waiters'
...
export const assignWaiterToTable = (waiterId, tableNo) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/waiter/assign/${waiterId}/${tableNo}`
