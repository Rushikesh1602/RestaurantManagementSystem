...
export const getallorders = () => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/customer/getallorders/${id}`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const paybill = (custId) => {
  return (dispatch) => {
    ...
    const id = custId
    console.log(custId)
    const url = `http://localhost:7070/customer/paybill/${custId}`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const feedback = (message, rating) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/customer/feedback`
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const getCart = () => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/cart/getcart/${custId}`
...
export const booktable = (tableNo, capacity) => {
  return (dispatch) => {
    ...
    const url = `http://localhost:7070/table/book`
...
export const updateCartQty = (menuId, qty) => {
  return (dispatch) => {
    ...
    const custId = sessionStorage['id']
    const url = `http://localhost:7070/cart/update/${custId}/${menuId}/${qty}`
...
export const cusPlaceOrder = (placeOrders) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/manager/add'
...
export const cusAddtoCart = (menuId, qty) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7070/cart/add'
